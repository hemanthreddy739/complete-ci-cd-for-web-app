...
# It's good practice to run update before dist-upgrade or install
...
# Setup NodeJS 20.x (Updated for Ubuntu 24.04 "Noble Numbat" support)
# Node.js 14.x is EOL and not supported on Ubuntu 24.04.
# Using a current LTS version like 20.x is highly recommended.
